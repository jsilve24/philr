...
replacement etc...) may be used instead if desired, by directly
manipulating the abundance table before calling `philr` (and setting
the pseudocount to its default value 0); the subsequent taxa weighting
procedure we will describe complements a variety of zero replacement
methods.
